...
class LibraryMangaItemsService {
  static final LibraryMangaItemsService instance = LibraryMangaItemsService();
  ...
  Future<void> delete(int id) async {
    await waka.transaction(() async {
      ...
      await LocalMangaConcreteViewService.instance.delete(item.localGalleryView.id!);
      await LocalMangaGalleryViewService.instance.delete(item.localGalleryView.id!);
