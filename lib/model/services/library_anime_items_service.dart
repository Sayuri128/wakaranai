...
class LibraryAnimeItemsService {
  static final LibraryAnimeItemsService _instance = LibraryAnimeItemsService();

  static LibraryAnimeItemsService get instance => _instance;
  ...
  Future<void> delete(int id) async {
    ...
    await LocalMangaGalleryViewService.instance.delete(item.id!);
  ...
  Future<LibraryAnimeItem> get(int id) async {
    ...
    return LibraryAnimeItem(
        ...
        localGalleryView: await LocalAnimeGalleryViewService.instance
            .get(libRes.first.localApiClientId));
  }
