...
ImportExportMode _$ImportExportModeFromJson(Map json) => ImportExportMode(
      ...
      exportedAt:
          const DateTimeJsonConverter().fromJson(json['exportedAt'] as String),
      mangaChapterActivities: (json['mangaChapterActivities'] as List<dynamic>)
          .map((e) => ChapterActivityDomain.fromJson(
              Map<String, dynamic>.from(e as Map)))
          .toList(),
      animeEpisodeActivities: (json['animeEpisodeActivities'] as List<dynamic>)
          .map((e) => AnimeEpisodeActivityDomain.fromJson(
              Map<String, dynamic>.from(e as Map)))
          .toList(),
    );
...
Map<String, dynamic> _$ImportExportModeToJson(ImportExportMode instance) =>
    <String, dynamic>{
      ...
      'mangaChapterActivities':
          instance.mangaChapterActivities.map((e) => e.toJson()).toList(),
      'animeEpisodeActivities':
          instance.animeEpisodeActivities.map((e) => e.toJson()).toList(),
    };
